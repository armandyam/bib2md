...
class TestBibToMd(unittest.TestCase):
    ...
    def test_parse_bib_file(self):
        ...
        self.assertTrue('journal123456' in bibdata)  # Replace 'some_entry' with an actual entry ID from the example.bib
    ...
    def test_write_md(self):
        ...
        self.assertTrue(os.path.exists(os.path.join('output', '2024-An-Innovative-Approach-to-Synthetic-Data-Generation.md')))  # Replace '2022-Sample-Title.md' with the actual expected file name
